...
const navigation = [
    {route: route('admin.index'), current: current('admin.index')},
]
...
<template>
    <div class="min-h-full">
        <div class="bg-gray-800">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <Link v-for="item in navigation" :key="item.route.name" :href="item.route.path"
                                      :class="[item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white', 'rounded-md px-3 py-2 text-sm font-medium']"
                                      :aria-current="item.current ? 'page' : undefined">{{ item.route.text }}
                                </Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="-mr-2 flex md:hidden">
                        <!-- Mobile menu button -->
                        <div @click="showingNavigationDropdown = !showingNavigationDropdown"
            ...
            <div class="md:hidden overflow-hidden" :class="{
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="flex items-center w-full"
                             @click="showingUserNavigationDropdown = !showingUserNavigationDropdown">
                            <div class="flex-shrink-0">
                    ...
                    <div :class="{'hidden': !showingUserNavigationDropdown}"
                         class="mt-3 space-y-1 px-2">
                        <Link v-for="item in userNavigation" :key="item.name" :method="item.method"
                              :href="item.path"
                              :as="item.method === 'post'? 'button' : 'a'"
