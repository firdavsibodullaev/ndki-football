...
@section('content')
    <div class="card">
        <div class="card-header bg-gradient-primary">
            <h5 class="card-title">{{ __('Редактирование турнира') }}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.tournament.update', $tournament->id) }}"
                  method="post"
                  autocomplete="off">
                @csrf
                @method('put')
...
{{--                                    <option @selected($type->value === $tournament->type->value)--}}
                ...
                <div class="form-group">
                    <div class="icheck-primary">
                        <input type="checkbox"
                               ...
                               @checked($tournament->is_home_away)
                               id="is_home_away">
